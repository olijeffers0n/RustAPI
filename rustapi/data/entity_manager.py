...
class EntityManager:
    ...
    def get_or_create_entity(
        self, entity_id: int, get: bool, value: bool = None
    ) -> Union[None, AppEntityPayload]:
        if not get:
            ...
            if entity_id in self.entities:
                ...
                if entity_data.protectionExpiry <= time.time():
                    entity_data.protectionExpiry = int(
                        time.time() + random.randint(30 * 60, 60 * 60 * 24 * 5)
                    )
                return entity_data
            else:
